...
const announce = [
  {
    people: "Web master",
    say: "我有幫新加入的成員在我們的ACM server (acm1.ipv6.club.tw) 建立帳號了！連線方式：帳號：s學號@163.22.20.115 -p 2021密碼：學號這台server是專屬我們ACM會員才可以使用的～",
  },
  {
    people: "Web master",
  ...
  {
    people:"Server小組的陳郁芳",
    say:"已經將新加入的成員在我們的ACM2 (acm2.ipv6.club.tw) 建立帳號~（要連VPN）連線方式如下：帳號：s學號@163.22.2.2 -p 2023密碼：學號"
  },
];
